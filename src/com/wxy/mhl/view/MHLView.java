package com.wxy.mhl.view;

import com.wxy.mhl.dao.BillDAO;
import com.wxy.mhl.domain.*;
import com.wxy.mhl.service.BillService;
import com.wxy.mhl.service.DiningTableService;
import com.wxy.mhl.service.EmployeeService;
import com.wxy.mhl.service.MenuService;
import com.wxy.mhl.utils.Utility;
...
public class MHLView {
    ...
    public void listDiningTable() {
        List<DiningTable> diningTableList = diningTableService.list();
        System.out.println("\n餐桌编号\t\t餐桌状态");
    ...
    public void orderDiningTable() {
        ...
        System.out.print("请选择要预定的餐桌的编号（-1退出）");
    ...
    public void cancelOrder(){
        ...
        System.out.print("请输入取消预订的餐桌号（-1退出）：");
        int diningTableId = Utility.readInt();
        if (diningTableId == -1) {
